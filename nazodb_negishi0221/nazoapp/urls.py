...
from .views import signupfunc, loginfunc, listfunc, logoutfunc, detailfunc, goodfunc, readfunc, RiddleList, RiddleDetail, RiddleCreate, RiddleDelete, RiddleUpdate
